  ...
  return (
    <>
      <p className="mb-3 rounded-md border border-warn/40 bg-warn/10 px-3 py-2 text-xs text-warn">
        ...
        saldata, che abbia almeno 12 anni e che il giorno rientri nella finestra ammessa.
      </p>
      ...
      <FormAzione azione={attivaGiornaliera}>
        ...
        <p className="mb-3 text-sm text-muted">
          ...
          <strong className="text-ink">{nome}</strong> e il giorno dell’attività. Servono data e
          luogo di nascita nella sua scheda.
        </p>
